...
public class Ship extends Polygon implements KeyListener {
	...
	private static boolean onebullet;
	...
	public void move() {
       ...
       /* if (onebullet) {
        	Point [] bulletPoints = super.getPoints();
        	center = bulletPoints[3];
        	Bullet bullet = new Bullet(center, rotation);
        	bullets.add(bullet);
        }*/
	...
	public void keyReleased(KeyEvent e) {
		...
		if(e.getKeyCode() == KeyEvent.VK_SPACE) {
			onebullet = true;
			System.out.println("key realesed");
			shoot = false;
		}
	}
